INSERT INTO "Пользователь"("Логин", "Пароль", "Никнейм", "Статус", "Дата последнего входа")
VALUES ('damir2407', 'aaaaaaa272', 'krutoi221', 'В сети', now()),
       ('susaasus1', 'asjdasjdajhd2', 'asus2', 'Не в сети', '2002-12-02'),
       ('eldar11', 'dsadsan2m22', 'eldarlim', 'В сети', now()),
       ('access','asd23jhajshd','sadkkks2','Не в сети','2013-05-09'),
       ('krutoi12','sadajklsl','krutoi222','В сети', now()),
       ('fish229','sadnesshapiness','sss2407','Не в сети','2022-10-13'), 
       ('houses','passwddd','reallycure','Не в сети', '2022-10-12');


INSERT INTO "Разработчик"("Логин", "Пароль", "Статус", "Дата последнего входа")
VALUES ('rob_david', 'asdsadkd2', 'В сети', now()),
       ('mike_tyson', 'znxmzcnz', 'Не в сети', '2002-02-10'),
       ('smith12', 'qwertdka', 'Не в сети', now()),
       ('opo21', 'azertya', 'Не в сети', now()),
       ('zxccursed', 'asdkdlkld2', 'В сети', now()),
       ('sdmmmd', '2kkskskw', 'В сети', now());
